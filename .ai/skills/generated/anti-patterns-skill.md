...
## Purpose
Document the patterns and practices that are explicitly avoided or forbidden in this codebase, inferred from the consistent implementation across all files.
