...
## Purpose
Define the specific Laravel implementation patterns used across this codebase including traits, filters, scopes, enums, exceptions, helpers, and custom abstractions.
