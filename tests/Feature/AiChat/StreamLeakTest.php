...
class StreamLeakTest extends TestCase
{
    ...
    protected function fakeProviderWithLeak(string $responseText = 'I should respond with final answer. Hello!'):
    {
        $this->app->singleton(LLMProviderInterface::class, fn () => new class($responseText) implements LLMProviderInterface {
            public function __construct(private string $text) {}
            public function send(array $messages, array $tools = [], array $options = []): array { return ['content' => $this->text, 'usage' => ['total_tokens' => 50]]; }
