---
name: performance
description: Use when optimizing queries, adding caching, queuing heavy operations, or addressing N+1 issues. Covers eager loading, Pipeline filters, Cache strategies, queued jobs, DB transactions, and pagination patterns.
---
