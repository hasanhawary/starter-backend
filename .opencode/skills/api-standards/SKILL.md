---
name: api-standards
description: Use when building or modifying API endpoints, resources, routes, or response formats. Covers the JSON envelope format, response helpers, resource transformation, Pipeline filtering, pagination, and routing conventions.
---
