...
return [
    ...
    'brands' => [
        ...
        'wakeb' => [
            ...
            'general' => [
                'info' => [
                    ['key' => 'company_name', 'value' => ['ar' => 'واكب', 'en' => 'Wakeb'], 'type' => 'text', 'placeholder' => ['ar' => 'اسم الشركة هنا', 'en' => 'Enter company name'], 'label' => ['ar' => 'اسم الشركة', 'en' => 'Company name'], 'is_multi_lang' => true],
    ...
    'jervis' => [
        'general' => [
            'info' => [
                ['key' => 'company_name', 'value' => ['ar' => 'جارفيس', 'en' => 'Jervis'], 'type' => 'text', 'placeholder' => ['ar' => 'اسم الشركة هنا', 'en' => 'Enter company name'], 'label' => ['ar' => 'اسم الشركة', 'en' => 'Company name'], 'is_multi_lang' => true],
                ['key' => 'copyright_name', 'value' => null, 'type' => 'text', 'placeholder' => ['ar' => 'حقوق الطبع والنشر', 'en' => 'Copyright name'], 'label' => ['ar' => 'حقوق الطبع والنشر', 'en' => 'Copyright name'], 'is_multi_lang' => true],
