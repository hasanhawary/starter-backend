...
This guide documents all services in the landing backend that handle core business logic.
...
Handles user login with support for email/password and LDAP authentication for both admin and landing users.
