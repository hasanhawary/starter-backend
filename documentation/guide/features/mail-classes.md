...
This guide documents the mail classes used for sending emails throughout the multi-tenant application.
...
9. **Tenant awareness** - Ensure emails are sent in correct tenant context
