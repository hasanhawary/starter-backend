---
title: Installation
description: Get the Multi-Tenant Dashboard Kit project up and running on your local machine
---

# Installation

This guide walks you through setting up the Multi-Tenant Dashboard Kit project locally for development.
...
- ✅ Creates MySQL database (central + tenant)
...
- The command creates both central and tenant databases automatically
- Central database stores tenant registry, plans, and subscriptions
- Tenant database is created for the default tenant

### Add New Tenant

After installation, create additional tenants:
...
# Run migrations and seeders for all tenants
