...
This guide documents all core Eloquent models in the landing backend, their relationships, and how to use them.

## User Model

**Location:** `app/Models/User.php`

The User model represents both admin and landing users in the system.
