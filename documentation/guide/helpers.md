...
The Landing Dashboard Kit provides numerous helper functions in `app/Helpers/App.php` that are auto-loaded and available globally throughout the application.
