...
description: Complete guide to the Multi-Tenant Dashboard Kit package ecosystem
---

# Tools & Packages Overview

The Multi-Tenant Dashboard Kit is powered by six custom-built packages that handle common development tasks. Learn how to use each tool to accelerate your development.
