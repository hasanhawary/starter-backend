---
title: Quick Start
description: Get started with the Multi-Tenant Dashboard Kit API in 5 minutes
---

# Quick Start

Learn the fundamentals of the Multi-Tenant Dashboard Kit API with real, practical examples.
