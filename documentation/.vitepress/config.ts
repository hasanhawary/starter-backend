...
export default defineConfig({
  ...
  head: [
    ...
    ["meta", { property: "og:title", content: "Landing Dashboard Kit Documentation" }],
    [
      "meta",
      {
  ...
  themeConfig: {
    logo: "/logo.svg",
    siteTitle: "Landing Dashboard Kit",
    nav: [
      { text: "Home", link: "/" },
      ...
      "/guide/": [
        ...
        },
        {
          ...
          items: [
            ...
            { text: "Dual-User System", link: "/guide/authentication" },
    ...
    footer: {
      ...
      copyright: "Copyright © 2025 Landing Dashboard Kit",
    },
  },
